<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityManagement.aspx.cs" Inherits="Web.e.admin.system.Basement.CityManagement" %>
            ...
            <tbody>
                <tr>
                    <td width="163">
                        省</td>
                    <td>
                        <asp:dropdownlist runat="server" ID="ddl_Province" AutoPostBack="True" 
