...
{
    public partial class JobEduSpecialtyManagement : AdminBase
    {
        ...
        protected TreeNode GetNode(List<JobEduSpecialty> lst, long id)
        {
            ...
            if (q_subs.Count() > 0)
            {
                foreach (JobEduSpecialty j in q_subs)
                {
